...
export default function FiltrosHistorialClasificacionCalidad(props: propsType): JSX.Element {
    ...
    return (
        <div className={`${theme === 'Dark' ? 'bg-gray-500' : 'bg-gray-200'} p-3 rounded-lg shadow-lg w-full`}>
