...
export default function DesverdizadoFInalizarDesverdizado(props:propsType) {
  ...
  return (
    ...
    <div className="bg-white rounded-xl  w-96 h-44">
      ...
      <div className="flex justify-center gap-4 mt-4">
        ...
        <button className="border border-gray-300 px-4 py-2 rounded-md" onClick={props.closeFinalizarDesverdizado}>
          Cancelar
        </button>
      </div>
    </div>
