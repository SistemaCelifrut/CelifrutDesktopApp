...
export default function ModalConfirmarEliminarProveedor(props:propsType): JSX.Element {
  return (
    ...
    <div className="bg-white rounded-xl  w-96 h-44">
      ...
      <div className="flex justify-center p-2">
        <h2 className="text-center">¿Esta seguro que desea eliminar el proveedor?</h2>
      </div>
