            ...
            <div className="form-container">
                {Object.keys(labels).map(item => (
                    <div key={item} className="proceso-aplicaciones-descarteLavado-div-form">
                        <p >{labels[item]}</p>
                        <input
                            onChange={(value): void => handleChange(item as keyof FormState, Number(value.target.value), "canastillas")}
                            placeholder="N. de canastillas"
                            type="number"
                            value={formState[item].canastillas}
                        />
                        <input
                            onChange={(value): void => handleChange(item as keyof FormState, Number(value.target.value), "kilos")}
                            placeholder="Kilos"
