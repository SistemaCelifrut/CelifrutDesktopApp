...
//   const obtenerHistorialFormularioInspeccionVehiculos = async (): Promise<void> => {
//     try {
...
//   const renderizarIcono = (valor: string): ReactElement | string => {
//     if (valor === 'C') {
...
//   const toggleExpansion = (contenedorId: string): void => {
//     setExpandedContenedor(expandedContenedor === contenedorId ? null : contenedorId);
//   };

//   const isContenedorExpanded = (contenedorId: string): boolean => {
//     return expandedContenedor === contenedorId;
//   };

//   const getCriterioNombre = (index: number): string => {
//     switch (index) {
//       case 1:
...
//   return (
//     <div className={` w-full p-4 ${theme === 'Dark' ? 'dark' : ''}`}>
...
//           placeholder="Placa"
//           value={placaFiltro}
//           onChange={(e): void => setPlacaFiltro(e.target.value.toUpperCase())} // Convertir automáticamente a mayúsculas
...
//           onChange={(e): void => setFechaInicioFiltro(e.target.value ? new Date(e.target.value + 'T00:00:00') : null)}
//           className="p-2 mr-2 border border-gray-300"
//         />
...
//           onChange={(e): void => setFechaFinFiltro(e.target.value ? new Date(e.target.value + 'T23:59:59') : null)}
...
//           value={nombreFiltro}
//           onChange={(e): void => setNombreFiltro(e.target.value)}
//           className="p-2 mr-3 border border-gray-300"
//         />
//         <input
//           type="number"
...
//           value={cantidadDatos || ''}
//           onChange={(e): void => setCantidadDatos(e.target.value)}
//           className="p-2 mr-2 border border-gray-300"
//         />
//       </div>
...
//                     <button onClick={(): void => toggleExpansion(contenedor._id)} className="focus:outline-none">
